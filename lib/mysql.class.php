...
class SafeMySQL
{
    ...
    function __construct($opt = array())
    {
        ...
        if ( !$this->conn )
        {               
            die("<div style='background-color:#F8D7DA; border: 1px solid #F8D7DA; border-radius: 5px; '>
                   <p style='font-family:Segoe UI,Frutiger,Frutiger Linotype,Dejavu Sans,Helvetica Neue,Arial,sans-serif; font-size: 16px; 
                             font-style: normal; font-weight: 400; line-height:24px; color:#721c24; margin: 10px 20px 10px'>
